...
import org.smartregister.chw.core.activity.CoreSbcMemberProfileActivity;
...
public class CoreSbcRegisterFragment extends BaseSbcRegisterFragment {
    private View view;
    ...
    protected void openProfile(String baseEntityId) {
        CoreSbcMemberProfileActivity.startMe(getActivity(), baseEntityId);
    }
